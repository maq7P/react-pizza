...
const CartItem = ({data, onDelItems, onAddItem, onDelItem}) => {
    return(
        <div className="cart__item">
            ...
            <div className="cart__item-info">
                ...
                <p>{data.item.type}, {data.item.size} см.</p>
            </div>
            <div className="cart__item-count">
                <Button
                    onClickToBtn={() => {onDelItem(data)}}
            ...
            <div className="cart__item-price">
                <b>{data.item.price * data.length} ₽</b>
            </div>
            <div className="cart__item-remove">
                <Button
                    onClickToBtn={() => {onDelItems(data)}}
